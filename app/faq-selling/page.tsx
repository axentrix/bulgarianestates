...
export default function FAQSellingPage() {
  ...
  const faqItems: FAQItem[] = [
    ...
    },
    {
      ...
      answer: 'Целта при продажбата е имотът да излезе на пазара в правилното време, на правилната цена, и да се реализира. Доста често имотът е с изгодна цена, но за него няма търсене поради факта, че се продава в момент, когато няма конкретен интерес към съответния тип имоти. Това води дo застой на пред��ожението на пазара, а впоследствие усилва недоверието от страна на купувачите.'
    },
    {
