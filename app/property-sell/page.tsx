            ...
            <div className="right-column-content">
              ...
              <div className="right-illustration">
                <svg className="illustration-bg" width="880" height="619" viewBox="0 0 880 619" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M557.098 291.884L320.052 265.594C317.607 265.323 315.758 263.257 315.758 260.797V48.6798C315.758 46.3533 317.418 44.358 319.705 43.9346L551.394 1.05563C554.361 0.5066 557.098 2.78381 557.098 5.80076V291.884Z" fill="#B8DD5F"/>
                  <path d="M492.265 80.9653C495.109 80.6746 497.581 82.9069 497.581 85.7661V211.873C497.581 214.608 495.31 216.797 492.577 216.695L384.563 212.693L379.927 212.53C377.33 212.438 375.271 210.306 375.271 207.707V97.2802C375.271 94.805 377.144 92.7311 379.607 92.4794L492.265 80.9653Z" fill="#AED357"/>
                  <path d="M487.778 91.3644C493.466 90.7838 498.409 95.2481 498.409 100.966V207.691C498.409 213.161 493.867 217.538 488.4 217.336L394.685 213.863C389.497 213.671 385.391 209.41 385.391 204.219V110.531C385.391 105.581 389.137 101.433 394.062 100.93L487.778 91.3644Z" fill="url(#paint0_linear_illustration)"/>
                  <path d="M556.867 292L765.643 265.754C768.057 265.451 769.867 263.398 769.867 260.966V48.6014C769.867 46.3181 768.267 44.3473 766.032 43.8785L562.684 1.22018C559.685 0.591159 556.867 2.87934 556.867 5.94309V292Z" fill="#2C9293"/>
                  <path d="M591.549 287.553L557.097 291.884L415.6 276.202V331.315L668.262 378.258V296.051L591.549 287.553Z" fill="#32AAAA"/>
                  <path d="M1125 619H0V281L1125 619Z" fill="#32AAAA"/>
                  <defs>
                    <linearGradient id="paint0_linear_illustration" x1="385.583" y1="108.581" x2="474.76" y2="217.989" gradientUnits="userSpaceOnUse">
