...
export default function HeroSection() {
  ...
  const cities = [
    ...
    'Плевен', '��лвичен', 'Д��брич', 'Шумен', 'Перник', 'Ямбол',
            ...
            {activeTab === 0 ? (
              ...
              <div className="simple-form-container">
                <div className="simple-form">
                  <h3 className="simple-form-subheading">
                    {activeTab === 1 && "Продавайте вашият имот бързо и лесно"}
                    {activeTab === 2 && "Намерете перфектният дом за наем"}
                    {activeTab === 3 && "Отдавайте под наем с доверие"}
                  </h3>
                  <div className="simple-form-controls">
                    <div className="form-field" ref={dropdownRef}>
                      ...
                      <input
                        ...
                        value={locationValue}
                        onChange={(e) => setLocationValue(e.target.value)}
                        onClick={() => handleDropdownToggle('simpleLocation')}
                        className="location-input"
                      />
                      <span className="field-label">Локация</span>

                      {/* Location Dropdown for Simple Form */}
                      {openDropdown === 'simpleLocation' && (
                        <div className="simple-location-dropdown">
                          <div className="dropdown-list">
                            {cities
                              .filter(city =>
                                city.toLowerCase().includes(locationValue.toLowerCase())
