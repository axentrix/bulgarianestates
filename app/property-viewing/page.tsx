      ...
      <div className="property-viewing-content">
        ...
        <div className="viewing-important-box">
          ...
          <div className="viewing-important-text">
            ...
            Разполагаме със собствен транспорт, който е напълно безплатен в рамките на населеното място, в което ще се извършва огледът. При трансфер или оглед, който надвишава 100 км., се заплаща единствено цената на изразходеното гориво.
          </div>
        </div>
      </div>
    </div>
